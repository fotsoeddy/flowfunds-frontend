...
export function CreditCard() {
  ...
  return (
    <div className="flex flex-col justify-center items-center py-8">
      <div className="flex flex-col justify-center items-center w-full max-w-md bg-white/40 backdrop-blur-sm shadow-sm rounded-3xl p-6">
        <div className="flex flex-col items-center justify-center gap-8 w-full">
          ...
          <div className="flex flex-col w-full items-center">
            ...
            {/* Back of Card */}
            <div className="relative overflow-hidden flex flex-col justify-between bg-white h-48 w-full max-w-[320px] rounded-xl pt-5 pb-4 italic text-[4px] transition shadow-xl duration-400 hover:scale-105 border border-gray-200">
              <div>
                <div className="bg-black h-10 w-full" />
                <div className="flex justify-between px-4 mt-4">
                  <div className="flex flex-col w-3/4">
                    <div className="flex justify-between px-1 mb-1 text-[6px] text-gray-600 not-italic">
                      <span>Authorized Signature</span>
                      <span>Not valid unless signed</span>
                    </div>
                    <div className="bg-gray-200 h-8 w-full flex items-center justify-end px-2">
                      <input
                        className="bg-transparent focus:outline-none w-8 text-right italic text-sm text-gray-800"
                        type="text"
                        maxLength={3}
                    ...
                    <div className="text-left mt-2 text-[5px] text-gray-400 leading-tight">
                      <p>
                  ...
                  <div className="flex flex-col items-end justify-center text-gray-400 text-[6px] not-italic">
                      <div>CIA 000012</div>
                      <div>CSM-1234--4321</div>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center gap-1 text-[6px] text-gray-400 not-italic">
                <span>
                  +234089876543, +234803456789
                </span>
        ...
        <button
          className={`mt-8 w-full rounded-lg h-12 bg-pink-600 text-white font-medium hover:bg-pink-700 transition-colors shadow-lg
        ${(error.expiryDate || error.number || error.cvv) && "opacity-50 cursor-not-allowed"}`}
